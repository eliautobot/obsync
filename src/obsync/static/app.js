...
async function renderVault() {
  ...
  $("#content").innerHTML = `
    ...
    <form class="settings-layout" id="vault-settings-form">
      ...
      <section class="settings-card full-width sweep-overview"><div class="section-head"><div><span class="eyebrow">ACTIVE VAULT CARE</span><h3>Maintenance Sweep</h3><p>Uses Local AI and the read-only Vault Knowledge Graph to place links only when a specific entity-to-entity edge has exact evidence in both notes. It never appends an Obsync relationship section or links notes merely because they share words, folders, tags, or a document type.</p></div><div class="settings-actions compact"><button class="secondary start-sweep" data-type="maintenance" type="button">Start Maintenance Sweep</button></div></div>
